...
export async function GET() {
  ...
  return Response.json({
    ...
    frame: withValidProperties({
      ...
      screenshotUrls: process.env.NEXT_PUBLIC_APP_SCREENSHOTS ? process.env.NEXT_PUBLIC_APP_SCREENSHOTS.split(',') : [],
      ...
      tags: process.env.NEXT_PUBLIC_APP_TAGS ? process.env.NEXT_PUBLIC_APP_TAGS.split(',') : [],
