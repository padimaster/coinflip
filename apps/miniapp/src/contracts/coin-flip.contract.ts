    ...
    "inputs": [
      {
        "name": "claimData",
        "type": "tuple",
        "internalType": "struct IFaucetContract.ClaimData",
        "components": [
          {
            "name": "userAddress",
            "type": "address",
